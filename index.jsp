                        ...
                        <tbody>
                            ...
                            %>
                                ...
                                <td > <a class="log-btn" style="text-decoration: none;color:white;"
                                        href="Book.jsp?Bus_no=<%=user.getBus_no()%>&From_city=<%=user.getFrom_city()%>&To_city=<%=user.getTo_city()%>&Date=<%=user.getDate()%>&Time=<%=user.getTime()%>&Price=<%=user.getprice()%>&Available_seats=<%=user.getavailable_seats()%>" > Book </a>  </td>
